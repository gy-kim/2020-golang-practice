...
/*
Reading and writing files are basic tasks needed for many Go probrams.
First we'll look at some example of reading files.
*/
import (
	"bufio"
	"fmt"
...
func main() {
	...
	// You'll open want more control over how and what parts of a file are read.
	...
	// The io package privides some functions that may by helpful for file reading.
